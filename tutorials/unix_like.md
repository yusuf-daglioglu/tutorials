...
| name                              | notes                                                                                                                                                                                                                                    |
|-----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| xterm                             | ilk olarak X window manager ile uyumlu çalışabilmesi için tasarlandığından "x" prefix'i takılmıştır.                                                                                                                                     |
...
`terminal emulator` ile çok benzer görevi vardır. menubar border içermezler ve `Terminal multiplexer` farklı `terminal emulator` içerisinden de çağrılabilirler.

Özellikle `desktop manager` veya `window manager` olmayan ekranlarda kullanılmak üzere tasarlanmışlardır.
...
burada basit bir anlatım var: https://devblogs.microsoft.com/commandline/windows-command-line-introducing-the-windows-pseudo-console-conpty/ "Enter, the Pseudo Terminal (PTY)" başlığı.
