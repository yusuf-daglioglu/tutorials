...
- İlgili iş yerinin DS'te kayıtlı olup olmadığını doğrulamak (bu durumda ilgili iş yerinin kaydı, hem DS'te, hem de MPI'da olmalıdır.)
...
- web dışındaki platformlara destek
  ...
  3d 1.0'da, SMS onay sayfasına yönlenme işi redirection ve "http post" işlemi ile gerçekleştirilmekteydi. dolayısı ile web dışındaki diğer platformlar 3d onayı almak istediklerinde webview kullanmak zorunda kalıyorlardı. artık 3d 2.0 ile web servisleri arasında haberleşme ile onay alınabileceğinden web teknolojilerine bağımlılıklar tamamen ortadan kalkmış oldu.
...
- Domain bazında incelersek:
  ...
  - interoperability domain
    - DS (ek not: Authentication History Server (or AHS), 2.0'da hiç bahsedilmiyor. Fakat istenirse, DS tarafına gömülü/arka planda kullanılıyor olabilir.)
  - Acquirer Domain
    - 3d 1.0'daki MPI yok
