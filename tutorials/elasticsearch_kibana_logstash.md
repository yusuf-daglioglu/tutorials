...
- __Auditbeat__; "Linux Audit Framework" ten topladığı audit bilgilerini toplar (Linux Audit Framework Linux'ta son kullanıcının yaptığı işlemleri tutmaktadır)
- __Metricbeat__; desteklediği birçok yazılımdan (MongoDB server, Redis, Zookeeper...) metric toplarlar.
...
"Open Distro" projesi Elasticsearch daha özgür fork'udur. "Open Distro" projesi, OpenSearch çıkınca durmuştur.

OpenSearch ekibi Logstash ve Beats gibi projeleri fork'lamadı. Çünkü zaten onlarla uyumlu çalışmaktadır.
