...
- Streaming (jackson-core)
  ...
  Burada xml/JSON derleme gibi işlemleri yapan core kodlar mevcut. alttaki tüm alt projeler bu projeye depend eder.
...
@JsonDeserialize(using = CustomDateDeserializer.class) bunun deserializer'ında kullanılan versiyonudur.
