...
## 📌 branching strategies (⟷ workflows ⟷ branching models)
...
- `MS Windows` için:
  ...
  - __Windows Credential Store for Git (⟷ git-credential-winstore)__ 3üncü parti olarak kullanılıyordu. Daha sonra __Git Credential Manager for Windows__ çıkınca __git-credential-winstore__ projesi durduruldu.
