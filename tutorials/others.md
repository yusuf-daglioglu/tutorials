...
özel bir kütüphane ismidir.

`RAM`'de ayrılan bir kısım, 2 process tarafından kullanılabilir.
...
COM sadece DTO için standartlaştırıcı bilgiler içerirken, DCOM baştan sonra network protocol'ü sunar.
...
- `fiber`
  ...
  programcının belirlediği kod bloklarında CPU tarafından interrupt edilebilirler.
