...
açık kaynaklı protokoldür. bir program, `TCP` üzerindeki haberleşme protokollerini kullanarak `API` sunarak hizmet sunar. `agent` external yerlerden bilgi toplamak icin bu `API`'lerden yararlanmir.
