...
- supports:
  ...
  - trailers
    ...
    bu bilgiler customd a verilebilir. yani ek trailer'lar manuel ekleyebiliriz.
...
# REST vs gRPC
REST bir yaklaşım mimarisi iken, gRPC bir teknolojidir. Fakat yaklaşımın (REST'in), tprotokole (gRPC'ye) uyup uymadığını tartışabiliriz. REST başlığında, detaylı uyumsuz ve uyumlu noktalardan bahsedilmiştir.
