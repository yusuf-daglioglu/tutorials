...
`fiber` terimi; developer'ın kod yazarak `yield` (veya benzeri isimde) fonksiyonunu çağırarak thread switch yapılabilmesini sağlayan `user-level thread`'lere verilen bir terimdir.
