...
React örnek kodları minimum Ecmascript 6 (güncel) sürümünü kullanır. fakat istenirse eski sürüm JS'ler ile de React kütüphanesi çağrılıp kullanılabilir. React kodları incelenirken JS'teki class gibi birçok yeni yapı görülebilmektedir.
