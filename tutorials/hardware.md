...
# USB version history
USB hızları ve geriye uyumluluk bilgileri başka başlıkta yazılmıştır ("STATISTICS & BENCHMARKS & SPEED" dosyasında).
...
3.1 Gen 1 (or SuperSpeed USB) girişi olduğu anlamına geliyor.

(Yukarıdaki şekle SS eklenmiş.)
...
3.1 Gen 2 (or SuperSpeed+ USB) girişi olduğu anlamına geliyor.

(Yukarıdaki şekle 10 eklenmiş)
...
(Yukarıdaki tüm şekiller eğer komple siyah bir arkaplana sahip ise)

USB girişinin "Power Delivery" özelliği vardır. Yani bu girişe takılan bir mobil cihaz, laptopu şart edebiliyor olacaktır.
...
Şimşek sigmesi, eğer USB girşinin yanında ise, o USB 'nin Thunderbolt olduğunu göstermez. Sadece hızlı şarj özelliğinin olduğunu gösterir. Bu da zaten, sadece o girişteki amper'in normalden fazla olduğunu belirtmek için kullanılır.

| Thunderbolt Sürümü | bu listede olan herhangi bir cihaz takıldığında onu kesin olarka destekliyor | Çıkış Tarihi |
|--------------------|------------------------------------------------------------------------------|--------------|
| 1                  |                                                                              | 2011         |
| 2                  |                                                                              | 2013         |
| 3                  | Thunderbolt 1 ve 2, USB-C, DisplayPort 1.2 (optional DisplayPort 1.4)        | 2015         |
| 4                  | Thunderbolt 3, USB-C, DisplayPort 1.4                                        | 2020         |
...
TianoCore EDK II'yı kullanarak sanala makinelerin UEFI yürütebilmesi için gerekli framework'tür. açık kaynaklıdır.