...
2. Ödeme işlemini yap
3. Başarılıysa "Ödeme başarılı" göster
4. Başarısızsa hata mesajını aynı sayfada göster. (böylece tekrar aynı sayfada form dolu şekilde gelir)
...
bu eklentilerde çalıştırmak için internette birçok hazır script paylaşılıyor.
...
- 3.0 ise Ethereum gibi smart-contract'larla çalışan web sayfalarıdır.
  ...
  Son kullanıcı rolü: veri sahibi/ortağı (son kullanıcı şifresi ile veri şifrelenmiştir. sadece veri sahibi bu datayı açabilir veya karşıya verebilir)
