...
ehcache'im dağıtık (distributed) yapısı yoktur. oysa Infinispan dapıtık yapısı vardır. eklentiler veya configurasyonlarla değiştirilebilir olsa da, en temel fark budur.
