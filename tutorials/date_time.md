...
- TZD, __time zone designator__'ın kısaltmasıdır ve formatta +hh:mm seklinde gösterilir. sadece Z kullanılırsa, +00:00 anlamına gelir.
  ...
  Ek not: Z harfi "__Zulu time__"'dan gelmektedir. 'Zulu time', askeri standartlarda (ACP 121(I)) +0 timezone'a denk gelen özel isimdir. ACP 121(I) standardında, saat bazlı her timezone için birer özel isim vardır. örneğin: Alpha Time Zone: +1, Bravo Time Zone +2, Charlie Time Zone: +3.
