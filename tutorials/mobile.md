...
fiziksel `SIM` kartın içine gömülü olan bir instruction listesidir. bunları mobile `OS` okur ve istediği biçimde ekranda son kullanıcıya göterir.

`STK`, `Android` dünyasında bunu yapan uygulamanın ismidir.
