...
her işaret specific bir metodu çağırıyor. yani; technologies liste objesinde - işareti minus isimli metodu execute ediyor. biz de yaptığımız sınıfta minus metodunu - işareti ile çağırabiliriz. << gibi diğer karakterler:
