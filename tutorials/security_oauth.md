...
- OpenID'dekine benzer bir süreç vardır. fakat web sitesi Twitter'dan contact bilgilerini almaz. aldığı token ile birlikte sürekli olarak arka planda Twitter'ın kaynaklarına user adına erişip işlem yapabilir. bu sebeple; Oauth bir yetkilendirme protokolüdür.
