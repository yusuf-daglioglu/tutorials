...
MS Windows ve MacOS native destek sağladıklarından beri artık Docker toolbox'a olan destek kaldırıldı. MS Windows ve MacOS'e kurulumlarda "Docker for Windows (or Docker Desktop for Windows)" veya "Docker for mac (or Docker Desktop for Mac)" kurulması öneriliyor.
...
mikroservislerin ağ yönetimi konuları için sunulan çözümlere verilen genel bir terimdir.
