...
distrobox %100 shell script projesidir. resmi sitesindeki "install" komutu, sadece shell script'leri bi dizine atar. yani tamamne portable'dır.

toolbx ise golang ile yazılmışb ri projedir.
