...
- kafka consumer grup bilgisini serverda tutarken şu şekilde tutar:
...
Fakat Kafka arkaplanda eski data'ları ilgili partition'lara move etmez. Kafka'dan consume edilen mesajlar zaten consumer tarafından işlenmiştir. Eski mesajlar özellikle okunmuyor ise, eski dataları move etmeye ihtiyacımız yok demektir.
