...
- Cookie-based session persistence:
  ...
  - Sadece basic-authantication destekleniyor.
...
Bunların içinde JWT(JSON Web Token) yok. JWT için implementasyonu yazılımcının kendisi yapması gerekiyor. Zaten JWT bir security metodu değildir, JWT data transferi yöntemidir.
