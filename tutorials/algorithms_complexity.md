...
__üstel artış__ (tersi __üstel azalma__), isminden de net anlaşıldığı gibi serideki her elemanın üstel oranda arttığını ifade eder.
...
Until we add X elements to Array-List, it should took all below time complexities:
