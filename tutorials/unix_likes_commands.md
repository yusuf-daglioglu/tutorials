...
Normal mode'dayken de sağa sola gidilebilir. bunun için sağa sol yerine, h j k l tuşları (or farklı tuşlar konfigüre edilebilir) kullanılabilir.
...
sadece __7-zip__ yazan bir makalede Windows build kastediliyor. Oysa __7-Zip for Linux/MacOS__ resmi 7-zip geliştiricilerinin MacOS ve Linux için geliştirdikleri 7-zip paketidir.
...
- 7-Zip'in içerisinde birçok binary vardır:
  ...
  - __7z.sfx__
    ...
    __self-extracting archive (or SFX or SEA)__ module only for MS Windows.
