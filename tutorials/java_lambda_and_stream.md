...
public static void main(String[] args) {
    ...
    // flatMap: "Map" metodu obje dönerken, flatMap stream dönülür.
...
Bunun birkaç sebebi var. Fakat en önemli sebep; Iterable'ın paralel olarak elemanları döndürememesidir. Fakat Stream'ler paralelde koşabiliyor. Burada uyumsuzluk olacağı için, artık yeni "__java.util.Spliterator__" sınıfı kullanılıyor. Yani "__iterable.spliterator()__", bir "__java.util.Spliterator__" sınıfı dönüyor.
