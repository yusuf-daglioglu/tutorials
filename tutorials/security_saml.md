...
`The Liberty Alliance` contributed its `Identity Federation Framework (or ID-FF)`, a fork of `OASIS`:
...
`saml` sadece Authentication protokolüdür. hem akış, hemde akıştaki mesajların içeriğini belirler.
