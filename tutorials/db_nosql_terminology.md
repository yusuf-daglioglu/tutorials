...
ID'si olan her bir nesneyi, ayrı birer fiziksel döküman olarak saklar. `kaynak: https://docs.microsoft.com/en-us/azure/architecture/data-guide/big-data/non-relational-data title: "Document data stores", 2th paragraph.`
