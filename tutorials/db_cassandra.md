...
- __Keyspace__, relational DB'deki şemaya veya DB'ye denk gelmektedir. en üst seviyeli DB kavramıdır.
- __column family__, relational DB'deki tabloya denk gelmektedir. Java'da şu objede tutulur:
  ...
  Aslında bakıldığında relational DB'de de aynı şekilde data'yı temsil edebiliriz: her satırın mutlaka bir ID'si olsun. her satırda, bir sütuna karşılık gelen bir değer vardır. (bu konu başka başlıkta anlatılıyor: "column family")

- __column key (⟷ column name)__ relational DB'deki sütun ismine denk gelmektedir. her column key'e karşılık gelen bir de __column value__ vardır.
