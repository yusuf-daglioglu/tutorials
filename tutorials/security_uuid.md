...
Gerçek hayat kullanımı: Her user'ın email adresinden bir UUID üretebiliriz. Bunları veritabanında UUID formatında saklayabiliriz.
...
## 📌 Uniform Resource Name (or URN) notation
