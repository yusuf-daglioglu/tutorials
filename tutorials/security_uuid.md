...
`UUID`, `rfc 4122`'da belirtilen standarttır.
...
`SHA-1`, `MD5`'e göre kırılması daha zor, ama günümüzde `SHA-1` artık güvenli kategorisinde değildir.
...
- 32 karakterdir ve arada tire koyularak (tireler sadece notasyondur, 128 bite dahil değildir) 5 grup olarak gösterilir:
