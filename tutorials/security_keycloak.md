...
# remember me
Login page'lerinde opsiyonel olarka "remember me" seçeneği sundurtulabiliyor. kullanıcı bunu seçip login olursa, artık browser kapatılıp açılsa bile, son kullanıc login olmuş olarak web sayfasını kullanmaya devam edebiliyor.