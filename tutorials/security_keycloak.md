...
- Keycloak'ın user, client, key gibi bilgileri tuttuğu bir database vardır.
...
Client, Keycloak'a, Keycloak'un sunduğu API veya HTML aracılığı ile login olur. Token'ı client her istekte back-end'e yollar.

- Eğer bu token JWT ise: her servisimiz bu token'ı kendi açar. Keycloak'a gitmeye gerek yoktur.
- Eğer bu token JWT değil ise: her defasında Keycloak'a back-end istek atıp, user'ın role bilgilerini istemelidir.
