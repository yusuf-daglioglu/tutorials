...
## 📌 Kayan Noktalı Literal'ler (or floating point literal)
...
- 1 --> sign (or işaret)
- 4.2 --> fraction (or tr:fraksiyon or tr:kesir) . Bu parçaya, "önemli" anlamına gelen "significant" terimi de kullanılmaktadır.
- 10 --> base (or taban)
- 5 --> exponent (or üs)
