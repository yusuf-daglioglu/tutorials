...
L4'ler TCP/IP katmanının 4üncü seviyesinde (Transport: TCP, UDP) manipülasyon yapabilir.

L7'ler TCP/IP katmanının 7inci seviyesinde (application layer: en üst seviye) manipülasyon yapabilirler.
...
- Apache HTTP Proxy
  ...
  API gateway __değildir!__ Fakat __bazı özellikleri__ Apigateway'ların sunduğu özelliklerle aynıdır.
