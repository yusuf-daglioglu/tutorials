...
bu property top, bottom, right, left gibidir. X ve Y koordinatlarına ek olarak Z koordinatını verir. elementler üst üste denk geldiğinde hangi elementin son kullanıcıya gözükeceğini belirlemek için kullanılır.
...
web tarayıcılarda olan "reader view" özelliği web tarayıcıların kendince kullandıkları bir yöntemdir. özel olarak CSS/JS'ten yakalanamamaktadırlar. örneğin web tarayıcıları "reader view"'a basılınca sadece en az 10 karakter içeren \<p> içindeki text'leri görüntülemektedirler.
