...
Burada sade bir anlatım mevcut: https://docs.microsoft.com/en-us/sql/odbc/reference/develop-app/transaction-isolation-levels?view=sql-server-ver15
...
- Note 1:
  ...
  Bu case'de sadece MSSQL kendi içinde istisna yapmış ve okumasına izin vermiş. `https://docs.microsoft.com/en-us/sql/t-sql/statements/set-transaction-isolation-level-transact-sql?view=sql-server-ver15 "Arguments" başlığı, "READ UNCOMMITTED" altbaşlığı, ikinci paragraf, ikinci cümle.`
...
- K1: "Arguments" başlığı, "REPEATABLE READ" altbaşlığı, ikinci paragraf.

- K2:

  - "Arguments" başlığı, "SERIALIZABLE" altbaşlığı, 2'inci paragraf ilk cümle.
