...
`JDBC` için `connection pool` kütüphanesidir. Buraya bakılırsa: `https://github.com/brettwooldridge/HikariCP/wiki/%22My-benchmark-doesn't-show-a-difference.%22#what-does-correctness-and-reliability-mean "What does correctness and reliability mean?" başlığı`, `Connection pool` yönetiminin ne gibi yetenekleri olduğu görülmektedir.
...
yukarıdaki tüm bilgiler için kaynak: `https://github.com/brettwooldridge/HikariCP/wiki/About-Pool-Sizing`
...
yukarıdaki bahsi geçen `pool` sayısı sadece 1 DB ve 1 app bu DB'de işlem yaparsa geçerlidir. diğer durumlarda farklı `connection pool` sayısı ile çalışmak daha verimli olabilir. `kaynak: https://github.com/brettwooldridge/HikariCP/issues/1023#issuecomment-345592654 "brettwooldridge" comment on November 20, 2017.`
