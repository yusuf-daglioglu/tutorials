...
orijinal elemanı callback'e geçiyor. dolayısı ile değişkenler burada değiştirilebilirler. fakat genel Javascript kuralları gereği bilinmesi gerekenler var. callback metodu yeni bir fonksiyon olacağı için geçilen değerler 2 durumda değiştirilemezler:
...
Typescript'in herhangi bir sürümü, Javascript'in herhangi bir sürümüne çevrilebilir. ancak istisna olarak bazı özellikler Javascript'te hiç desteklenmiyor olabilir. böyle durumlarda, JS tarafında sürüm yükseltmek gerekebilir.
