...
Javascript nesneye yönelimli değildir. nesne kullanır bu sebeple nesne tabanlıdır. fakat nesneye yönelimli dillerin desteklemesi gerektiği özellikleri destekleyecek şekilde özenle geliştirilmez. örneğin Javascript'te inheritance ve polymorphism yoktur. son çıkan Javascript sürümlerinde sınıflar gelmiştir. fakat bu seferde encapsulation yoktur.
