...
- (Immutable) Veri Yapıları vardır. yani; veriyi değiştirmek yerine kopyalayarak yeni versiyonlar üretildiği,
  ...
  Not-1: Object-orianted'ta ise, bir nesnenin durumu sürekli değişir.

  Not-2: Bunun sonucu olark aynı nesneni state'i değişmeyeceği için, for-loop gibi döngüler yerine rekürsif fonksiyon çağırmaları daha sıkça tercih edilir.

- pure fonksiyonlar ile çalışıldığı,

- fonksiyonlar fonksiyonlara parametre olarak geçilebildiği, return edilebildiği, bir variable'da tutulabildiği, (bu madde fonskiyonel olmanın bir zorunluğu diil, ama %90 tercih edilen bir durumdur)
