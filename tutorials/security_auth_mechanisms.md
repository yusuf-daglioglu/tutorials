...
dosya paylaşım için yetkilendirme protocol'üdür.
...
`SMB` yetkilendirme protocol'üdür. Login için kendi basit bir mekanizma destekler, ama istenirse `LDAP` ile login olunmasını da sağlayabilir.

## 📌 Kerberos

Sadece Kimlik doğrulama protocol'üdür.
