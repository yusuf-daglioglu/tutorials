...
## 📌 modifiers for: sub-class or internal members of class
...
- cache
- buffer
- protokol standartları gereği belli bir boyuta gelmesi beklenir.
...
MyService.java gibi bir sınıftır. Bu sınıf her sınıfın içinden şu şekillerde çağrılabilir:
