...
Elimizde bir dizi olsun ve dizinin her elemanını bir DOM nesnesinin içine append edelim. Bunun için for-loop döner ve her defasında append child çağırırız. İşte her appendChild metodunu çağırdığımızda re-flow gerçekleşir. Performansı olumsuz etkiler.
