...
- __stakeholder__
  ...
  - Sales and Marketing teams of developed product

  - support teams

- `development team`
  - In 2020, the term update as `developers`.
  - Those people are only the people who develop the software. They should not be separated as subgroups. If they should separate, these subgroups should be independent `Scrum` teams.
...
- `Product Backlog refinement`
  ...
  - Term `Grooming` replaced as `refinement` with official `scrum guide` 2013.
...
- __increment__
  ...
  - Every task should be `Done`. Otherwise they are not accepted as a `increment`.
