...
- her sınıfın toString'i olmalı ki log'lar düzgünce basılabilsin. fakat gizli bilgiler log'a basılmayacağı için onlara ekstra dikkat edilmeli. gerekirse toString'den gizli bilgiler çıkarılmalı veya hash'lenerek tutulmalı (or hash'lenerek print edilmeli).
