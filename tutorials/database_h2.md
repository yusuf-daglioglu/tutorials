...
But H2 server is compatible with different dialects. But the database connection should initialize with specific mode. example JDBC URL compatible with MSSQLServer:
